...
var ShowFollowers = function () {
    ...
    var _c = react_1.useState(0), followerCount = _c[0], setFollowerCount = _c[1];
    ...
    react_1.useEffect(function () {
        ...
        function getUserFollowers() {
            return __awaiter(this, void 0, void 0, function () {
                var fetchUserFollowers, userInfo;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch(API_BASE_1["default"] + "/get-user-followers/" + window.location.pathname.split('/')[2])];
                        case 1:
                            fetchUserFollowers = _a.sent();
                            return [4 /*yield*/, fetchUserFollowers.json()];
                        case 2:
                            userInfo = _a.sent();
                            if (!userInfo.success) {
    ...
    document.title = name + "'s " + (followerCount !== 1 ? followerCount + " followers" : '1 follower') + " | Instagram Clone";
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        followerCount === 0 ? (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement("br", null),
            react_1["default"].createElement("h3", null,
                name,
                " doesn't appear to have any followers yet :(.",
                react_1["default"].createElement(react_router_dom_1.Link, { to: "/user/" + name }, " Follow them now!")))) : (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement("h1", null,
                ...
                ":"),
            react_1["default"].createElement("br", null))),
        followers.map(function (follower) { return (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement("div", { className: 'followerInfo' },
                react_1["default"].createElement(react_router_dom_1.Link, { to: "/user/" + follower['username'] },
                    react_1["default"].createElement("img", { className: 'pfp', src: follower['pfp'], alt: follower['username'] })),
                react_1["default"].createElement("span", { className: 'followerName' },
                    "\u00A0",
                    react_1["default"].createElement(react_router_dom_1.Link, { to: "/user/" + follower['username'] }, follower['username']))),
            react_1["default"].createElement("hr", null))); })));
};
exports["default"] = ShowFollowers;
