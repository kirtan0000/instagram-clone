...
var SignUp = function () {
    ...
    var _e = react_1.useState(''), errorMessage = _e[0], setError = _e[1];
    var _f = react_1.useState(false), showPass = _f[0], setShowPass = _f[1];
    ...
    var onUsernameChange = function (event) { return setUsername(event.target.value); };
    var onConfirmPasswordChange = function (event) {
    ...
    var handleSubmit = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var urlencoded, signUpUser, signUpData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(API_BASE_1["default"] + "/create-user", {
                            method: 'POST',
                ...
                case 1:
                    signUpUser = _a.sent();
                    return [4 /*yield*/, signUpUser.json()];
                case 2:
                    signUpData = _a.sent();
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement("div", { id: 'form' },
            react_1["default"].createElement("div", { className: 'centeredForm' },
                react_1["default"].createElement("h1", { id: 'heading-acc-manage', className: 'celestial-gradient-text' }, "Sign Up to Instagram Clone"),
                            ...
                            react_1["default"].createElement("div", { id: 'login', className: 'tab-content tab-content-active' },
                                react_1["default"].createElement("form", { onSubmit: handleSubmit },
                                    react_1["default"].createElement("div", { className: 'form-group form-animate' },
                                        react_1["default"].createElement("label", { htmlFor: 'login-username', className: 'form-label endless-river-gradient-text' }, "Username"),
                                        react_1["default"].createElement("input", { className: 'input-animate', id: 'login-username', placeholder: 'SomeNameHere', required: true, onChange: onUsernameChange })),
                                    react_1["default"].createElement("div", { className: 'form-group form-animate' },
                                        react_1["default"].createElement("label", { htmlFor: 'login-username', className: 'form-label endless-river-gradient-text' }, "Email"),
                                        react_1["default"].createElement("input", { type: 'email', className: 'input-animate', id: 'login-email', placeholder: 'test@example.com', required: true, onChange: onEmailChange })),
                                    react_1["default"].createElement("div", { className: 'form-group form-animate' },
                                    ...
                                    react_1["default"].createElement("div", { className: 'form-group form-animate' },
                                        react_1["default"].createElement("label", { htmlFor: 'login-password', className: 'form-label endless-river-gradient-text' }, "Confirm Password"),
                                        react_1["default"].createElement("input", { type: showPass ? 'text' : 'password', className: 'input-animate emerald-gradient-text', id: 'login-password', placeholder: 'SuperSecretPassword', onChange: onConfirmPasswordChange, required: true })),
